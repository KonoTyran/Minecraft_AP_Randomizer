...
public class APStructures {
    ...
    public static final DeferredRegister<StructureType<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(Registry.STRUCTURE_TYPE_REGISTRY, APRandomizer.MODID);
    ...
    public static final TagKey<Structure> VILLAGE_TAG = TagKey.create(Registry.STRUCTURE_REGISTRY, new ResourceLocation("aprandomizer:village"));
    public static final TagKey<Structure> OUTPOST_TAG = TagKey.create(Registry.STRUCTURE_REGISTRY, new ResourceLocation("aprandomizer:pillager_outpost"));
    public static final TagKey<Structure> END_CITY_TAG = TagKey.create(Registry.STRUCTURE_REGISTRY, new ResourceLocation("aprandomizer:end_city"));
    public static final TagKey<Structure> BASTION_REMNANT_TAG = TagKey.create(Registry.STRUCTURE_REGISTRY, new ResourceLocation("aprandomizer:bastion_remnant"));
    public static final TagKey<Structure> FORTRESS_TAG = TagKey.create(Registry.STRUCTURE_REGISTRY, new ResourceLocation("aprandomizer:fortress"));
